  ...
  return (
    <SmoothScroll>
      ...
      <main className="px-5 pb-24 pt-32 md:px-10 md:pt-40">
        <header className="mx-auto max-w-3xl border-b-2 border-tinta pb-10">
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mt-10 space-y-4 text-base leading-relaxed text-tinta/80 md:text-lg">
            {intro.map((p, i) => (
              <p key={i}>{p}</p>
            ))}
          </div>
          ...
          {secciones.map((sec) => (
            <section key={sec.titulo} className="mt-14">
